...
import { WorkspacePanel } from "@/components/workspace/WorkspacePageShell";
...
import LineageExportButton from "./LineageExportButton";
import LineageHeatmap from "./LineageHeatmap";
...
interface LineageWorkspaceContentProps {
  embedded?: boolean;
}

export function LineageWorkspaceContent({
  embedded = false,
}: LineageWorkspaceContentProps) {
