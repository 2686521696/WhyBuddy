      ...
      <div className="space-y-1.5">
        <div className="relative">
          <textarea
            ...
            disabled={loading}
            className={cn(
              "w-full resize-none rounded-xl border border-transparent bg-transparent text-stone-900 placeholder:text-stone-400 focus:border-transparent focus:outline-none focus:ring-0 disabled:opacity-50",
              dense
                ? "rounded-[12px] px-2.5 py-1.5 text-[13px] leading-5"
                : "px-3 py-2.5 text-sm"
            )}
