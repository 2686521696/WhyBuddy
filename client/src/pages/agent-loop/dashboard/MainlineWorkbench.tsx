  ...
  const tone =
    state === "ok"
      ...
      : state === "down"
        ...
        : "bg-[#F5F1EA] text-stone-400 ring-[#E7E2D9]";
  return (
...
function SectionCard({
  ...
  return (
    <section className="rounded-2xl border border-[#E7E2D9] bg-white p-4 shadow-[0_1px_3px_rgb(90_80_60/0.06)]">
    ...
    <div className="mx-auto max-w-[1200px] space-y-4 p-5" data-testid="mainline-workbench">
      <div className="flex items-end justify-between">
        ...
        <button
          ...
          className="rounded-full border border-[#E7E2D9] bg-white px-4 py-1.5 text-[12px] font-semibold text-stone-600 transition hover:bg-[#F5F1EA]"
        >
          ↻ 刷新
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-5">
        ...
        <div className="lg:col-span-3">
          ...
          >
            {sessions.kind === "loading" && <div className="h-24 animate-pulse rounded-lg bg-[#F5F1EA]" />}
            {sessions.kind === "error" && (
            ...
            {sessions.kind === "ok" && (
              <table className="w-full text-[12px]" data-testid="wb-sessions">
                <thead>
                  <tr className="border-b border-[#F0EDE5] text-left text-[11px] text-stone-400">
                ...
                <tbody>
                  {sessionRows.map((s) => {
                    ...
                    return (
                      <tr key={s.sessionId} className="border-b border-[#FAF8F3] last:border-0">
        ...
        <div className="space-y-4 lg:col-span-2">
          ...
          <SectionCard title="生成质量基线（五域评测）">
            {baseline.kind === "loading" && <div className="h-20 animate-pulse rounded-lg bg-[#F5F1EA]" />}
            {baseline.kind === "error" && (
              <div className="text-[12px] text-stone-400">
                基线不可用（未生成或 python 未启动）。用
                <code className="mx-1 rounded bg-[#F5F1EA] px-1 font-mono text-[11px]">
            ...
            {baseline.kind === "ok" && baselineSummary && (
              <div data-testid="wb-baseline">
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div className="rounded-lg bg-[#FAF8F3] px-2 py-2.5">
