...
export const ENTITY_ROWS: Record<string, RuntimeRow[]> = {
  ...
  fileShareDemo: [
    {id: "share-design",values:{sharePrincipal: "产品设计组",shareKind: "internal",sharePermission: "可编辑",shareExpiry: "",shareStatus: "直接分享",},createdAt: "2026-08-11T14:00:00.000Z",},
    {id: "share-review",values:{sharePrincipal: "林女士",shareKind: "internal",sharePermission: "仅查看",shareExpiry: "",shareStatus: "继承自项目组",},createdAt: "2026-08-11T14:01:00.000Z",},
    {id: "share-public",values:{sharePrincipal: "客户评审链接",shareKind: "link",sharePermission: "查看与下载",shareExpiry: "2026-08-31",shareStatus: "密码保护",},createdAt: "2026-08-11T14:02:00.000Z",},
  ],
  identitySessionDemo: [
    {id: "session-current",values:{sessionUser: "wang.xiao",sessionClient: "WhyBuddy Web",sessionDevice: "Chrome · Windows（current）",sessionIp: "10.24.8.16",sessionLastAccess: "刚刚",},createdAt: "2026-08-11T14:00:00.000Z",},
    {id: "session-phone",values:{sessionUser: "wang.xiao",sessionClient: "WhyBuddy Mobile",sessionDevice: "Safari · iPhone",sessionIp: "10.24.9.42",sessionLastAccess: "8 分钟前",},createdAt: "2026-08-11T13:52:00.000Z",},
    {id: "session-cli",values:{sessionUser: "wang.xiao",sessionClient: "Deployment CLI",sessionDevice: "Token · macOS",sessionIp: "172.16.4.8",sessionLastAccess: "2 小时前",},createdAt: "2026-08-11T12:00:00.000Z",},
  ],
  columnLineageDemo: [
    {id: "lineage-source",values:{lineageDataset: "ods.payment_events",lineageColumn: "customer_id",lineageDirection: "upstream",lineageDepth:1,lineageImpact:12,},createdAt: "2026-08-11T14:00:00.000Z",},
    {id: "lineage-current",values:{lineageDataset: "dwd.orders",lineageColumn: "customer_id",lineageDirection: "downstream",lineageDepth:0,lineageImpact:18,},createdAt: "2026-08-11T14:01:00.000Z",},
    {id: "lineage-mart",values:{lineageDataset: "mart.customer_value",lineageColumn: "buyer_id",lineageDirection: "downstream",lineageDepth:1,lineageImpact:26,},createdAt: "2026-08-11T14:02:00.000Z",},
    {id: "lineage-report",values:{lineageDataset: "bi.customer_dashboard",lineageColumn: "customer_key",lineageDirection: "downstream",lineageDepth:2,lineageImpact:34,},createdAt: "2026-08-11T14:03:00.000Z",},
  ],
  workflowCredentialDemo: [
    {id: "cred-slack-main",values:{credentialSlot: "Slack 通知",credentialName: "生产 Slack Bot",credentialType: "Slack OAuth2",credentialStatus: "success",credentialRequired: "true",},createdAt: "2026-08-11T14:00:00.000Z",},
    {id: "cred-slack-backup",values:{credentialSlot: "Slack 通知",credentialName: "备用 Slack Bot",credentialType: "Slack OAuth2",credentialStatus: "idle",credentialRequired: "true",},createdAt: "2026-08-11T14:01:00.000Z",},
    {id: "cred-db-main",values:{credentialSlot: "订单数据库",credentialName: "订单只读账户",credentialType: "PostgreSQL",credentialStatus: "error",credentialRequired: "true",},createdAt: "2026-08-11T14:02:00.000Z",},
    {id: "cred-storage",values:{credentialSlot: "归档存储",credentialName: "S3 归档账户",credentialType: "S3",credentialStatus: "success",credentialRequired: "false",},createdAt: "2026-08-11T14:03:00.000Z",},
  ],
  mergeApprovalDemo: [
    {id: "approval-security-a",values:{approvalRule: "安全评审",approvalRequired:2,approvalReceived:1,approvalApprover: "陈晓",approvalOptional: "false",approvalInvalid: "false",},createdAt: "2026-08-11T14:00:00.000Z",},
    {id: "approval-security-b",values:{approvalRule: "安全评审",approvalRequired:2,approvalReceived:1,approvalApprover: "林海",approvalOptional: "false",approvalInvalid: "false",},createdAt: "2026-08-11T14:01:00.000Z",},
    {id: "approval-owner",values:{approvalRule: "代码所有者",approvalRequired:1,approvalReceived:1,approvalApprover: "王若溪",approvalOptional: "false",approvalInvalid: "false",},createdAt: "2026-08-11T14:02:00.000Z",},
    {id: "approval-product",values:{approvalRule: "产品确认",approvalRequired:1,approvalReceived:0,approvalApprover: "赵敏",approvalOptional: "true",approvalInvalid: "false",},createdAt: "2026-08-11T14:03:00.000Z",},
  ],
  documentMailRuleDemo: [
    {id: "mail-from",values:{mailAccount: "invoice@miantuan.ai",mailFolder: "INBOX",mailCondition: "发件人",mailAction: "mark-read",mailActionParameter: "",mailMetadata: "通信方：按发件人",},createdAt: "2026-08-11T14:00:00.000Z",},
    {id: "mail-subject",values:{mailAccount: "finance@miantuan.ai",mailFolder: "Invoices",mailCondition: "主题",mailAction: "move",mailActionParameter: "Processed",mailMetadata: "文档类型：发票",},createdAt: "2026-08-11T14:01:00.000Z",},
    {id: "mail-attachment",values:{mailAccount: "invoice@miantuan.ai",mailFolder: "Archive",mailCondition: "附件名",mailAction: "tag",mailActionParameter: "已归档",mailMetadata: "标签：待报销",},createdAt: "2026-08-11T14:02:00.000Z",},
    {id: "mail-body",values:{mailAccount: "finance@miantuan.ai",mailFolder: "INBOX",mailCondition: "正文",mailAction: "mark-read",mailActionParameter: "",mailMetadata: "所有者：财务组",},createdAt: "2026-08-11T14:03:00.000Z",},
  ],
  authenticationFlowDemo: [
    {id: "browser-flow",values:{authExecutionName: "Browser 登录流",authParent: "",authRequirement: "REQUIRED",authPriority:0,authConfigurable: "true",},createdAt: "2026-08-11T15:00:00.000Z",},
    {id: "cookie-check",values:{authExecutionName: "Cookie 检查",authParent: "browser-flow",authRequirement: "ALTERNATIVE",authPriority:10,authConfigurable: "false",},createdAt: "2026-08-11T15:01:00.000Z",},
    {id: "login-form",values:{authExecutionName: "用户名密码表单",authParent: "browser-flow",authRequirement: "ALTERNATIVE",authPriority:20,authConfigurable: "true",},createdAt: "2026-08-11T15:02:00.000Z",},
    {id: "otp-step",values:{authExecutionName: "一次性验证码",authParent: "login-form",authRequirement: "CONDITIONAL",authPriority:10,authConfigurable: "true",},createdAt: "2026-08-11T15:03:00.000Z",},
  ],
  dashboardFilterScopeDemo: [
    {id: "filter-region",values:{scopeKind: "filter",scopeLabel: "销售区域",scopeParent: "",scopeFilter: "",},createdAt: "2026-08-11T15:00:00.000Z",},
    {id: "filter-channel",values:{scopeKind: "filter",scopeLabel: "渠道来源",scopeParent: "",scopeFilter: "",},createdAt: "2026-08-11T15:01:00.000Z",},
    {id: "page-overview",values:{scopeKind: "page",scopeLabel: "经营总览",scopeParent: "",scopeFilter: "",},createdAt: "2026-08-11T15:02:00.000Z",},
    {id: "tab-sales",values:{scopeKind: "tab",scopeLabel: "销售分析",scopeParent: "page-overview",scopeFilter: "",},createdAt: "2026-08-11T15:03:00.000Z",},
    {id: "chart-revenue",values:{scopeKind: "chart",scopeLabel: "收入趋势",scopeParent: "tab-sales",scopeFilter: "filter-region",},createdAt: "2026-08-11T15:04:00.000Z",},
    {id: "chart-funnel",values:{scopeKind: "chart",scopeLabel: "转化漏斗",scopeParent: "tab-sales",scopeFilter: "filter-region",},createdAt: "2026-08-11T15:05:00.000Z",},
  ],
  fulfillmentAllocationDemo: [
    {id: "line-tee-east",values:{fulfillLine: "line-tee",fulfillProduct: "团队纪念 T 恤",fulfillOrdered:8,fulfillWarehouse: "华东中心仓",fulfillAvailable:6,fulfillPreorder: "false",},createdAt: "2026-08-11T15:00:00.000Z",},
    {id: "line-tee-south",values:{fulfillLine: "line-tee",fulfillProduct: "团队纪念 T 恤",fulfillOrdered:8,fulfillWarehouse: "华南前置仓",fulfillAvailable:5,fulfillPreorder: "false",},createdAt: "2026-08-11T15:01:00.000Z",},
    {id: "line-mug-east",values:{fulfillLine: "line-mug",fulfillProduct: "联名马克杯",fulfillOrdered:3,fulfillWarehouse: "华东中心仓",fulfillAvailable:2,fulfillPreorder: "false",},createdAt: "2026-08-11T15:02:00.000Z",},
    {id: "line-mug-north",values:{fulfillLine: "line-mug",fulfillProduct: "联名马克杯",fulfillOrdered:3,fulfillWarehouse: "华北仓",fulfillAvailable:4,fulfillPreorder: "false",},createdAt: "2026-08-11T15:03:00.000Z",},
  ],
  alertExpressionDemo: [
    {id: "alert-a",values:{expressionRef: "A",expressionKind: "Query",expressionInput: "",expressionFormula: "rate(http_errors_total[5m])",expressionPreview: "success",},createdAt: "2026-08-11T15:00:00.000Z",},
    {id: "alert-b",values:{expressionRef: "B",expressionKind: "Reduce",expressionInput: "A",expressionFormula: "last(A)",expressionPreview: "success",},createdAt: "2026-08-11T15:01:00.000Z",},
    {id: "alert-c",values:{expressionRef: "C",expressionKind: "Threshold",expressionInput: "B",expressionFormula: "B > 0.05",expressionPreview: "success",},createdAt: "2026-08-11T15:02:00.000Z",},
  ],
  syncWaveDemo: [
    {id: "sync-migrate",values:{syncResource: "db-migrate",syncPhase: "PreSync",syncWave:-1,syncKind: "Job",syncStatus: "healthy",},createdAt: "2026-08-11T15:00:00.000Z",},
    {id: "sync-config",values:{syncResource: "orders-config",syncPhase: "Sync",syncWave:0,syncKind: "ConfigMap",syncStatus: "synced",},createdAt: "2026-08-11T15:01:00.000Z",},
    {id: "sync-api",values:{syncResource: "orders-api",syncPhase: "Sync",syncWave:1,syncKind: "Deployment",syncStatus: "progressing",},createdAt: "2026-08-11T15:02:00.000Z",},
    {id: "sync-smoke",values:{syncResource: "smoke-test",syncPhase: "PostSync",syncWave:2,syncKind: "Job",syncStatus: "pending",},createdAt: "2026-08-11T15:03:00.000Z",},
  ],
  scaffolderTaskDemo: [
    {id: "task-fetch",values:{taskStep: "读取模板",taskStepStatus: "completed",taskLog: "Template skeleton fetched\nParameters validated",taskOutput: "",taskDuration:4,},createdAt: "2026-08-11T15:00:00.000Z",},
    {id: "task-render",values:{taskStep: "生成项目",taskStepStatus: "completed",taskLog: "Rendered 42 files\nApplied catalog metadata",taskOutput: "catalog-info.yaml",taskDuration:11,},createdAt: "2026-08-11T15:01:00.000Z",},
    {id: "task-publish",values:{taskStep: "发布仓库",taskStepStatus: "failed",taskLog: "git push origin main\nERROR: branch protection requires review",taskOutput: "https://git.example.com/platform/orders-api",taskDuration:7,},createdAt: "2026-08-11T15:02:00.000Z",},
  ],
  rackUnitDemo: [{ id: "rack-api-front", values: { rackAsset: "API-01", rackSide: "front", rackPosition: 12, rackHeight: 2, rackLane: 0, rackStatus: "placed" }, createdAt: "2026-08-11" }, { id: "rack-switch-front", values: { rackAsset: "Core Switch", rackSide: "front", rackPosition: 8, rackHeight: 1, rackLane: 1, rackStatus: "placed" }, createdAt: "2026-08-11" }, { id: "rack-pdu-rear", values: { rackAsset: "PDU-A", rackSide: "rear", rackPosition: 2, rackHeight: 5, rackLane: 0, rackStatus: "placed" }, createdAt: "2026-08-11" }],
  deviceCommandDemo: [{ id: "cmd-duration", values: { commandType: "engineStop", commandAttribute: "持续时间", commandAttributeType: "number", commandRequired: "true", commandValue: "30", commandAvailable: "true" }, createdAt: "2026-08-11" }, { id: "cmd-reason", values: { commandType: "engineStop", commandAttribute: "原因", commandAttributeType: "string", commandRequired: "true", commandValue: "维护窗口", commandAvailable: "true" }, createdAt: "2026-08-11" }],
  subscriptionPhaseDemo: [{ id: "phase-trial", values: { subscriptionPlan: "Growth", subscriptionPhase: "TRIAL", catalogPrice: 0, overridePrice: 0 }, createdAt: "2026-08-11" }, { id: "phase-discount", values: { subscriptionPlan: "Growth", subscriptionPhase: "DISCOUNT", catalogPrice: 49, overridePrice: 39 }, createdAt: "2026-08-11" }, { id: "phase-evergreen", values: { subscriptionPlan: "Growth", subscriptionPhase: "EVERGREEN", catalogPrice: 99, overridePrice: 89 }, createdAt: "2026-08-11" }],
  documentMoveDemo: [{ id: "collection-product", values: { moveCollection: "产品文档", movePermission: "view-edit", moveParent: "", moveCurrent: "true", moveWritable: "true", moveDescendant: "false" }, createdAt: "2026-08-11" }, { id: "collection-public", values: { moveCollection: "公开知识库", movePermission: "view-only", moveParent: "", moveCurrent: "false", moveWritable: "true", moveDescendant: "false" }, createdAt: "2026-08-11" }, { id: "collection-archive", values: { moveCollection: "历史归档", movePermission: "no-access", moveParent: "", moveCurrent: "false", moveWritable: "false", moveDescendant: "false" }, createdAt: "2026-08-11" }],
  ciStageDemo: [{ id: "ci-build", values: { ciStage: "Build", ciJob: "compile", ciStatus: "success", ciNeeds: "", ciParallel: 1, ciAuthorized: "true" }, createdAt: "2026-08-11" }, { id: "ci-unit", values: { ciStage: "Test", ciJob: "unit [1/3]", ciStatus: "failed", ciNeeds: "success", ciParallel: 3, ciAuthorized: "true" }, createdAt: "2026-08-11" }, { id: "ci-deploy", values: { ciStage: "Deploy", ciJob: "production", ciStatus: "manual", ciNeeds: "success", ciParallel: 1, ciAuthorized: "true" }, createdAt: "2026-08-11" }],
  serialBatchDemo: [{ id: "serial-001", values: { serialItem: "扫码终端", serialNumber: "SN-001", batchNumber: "B-202608", allocationQty: 1, requiredQty: 3, allocationWarehouse: "华东中心仓" }, createdAt: "2026-08-11" }, { id: "serial-002", values: { serialItem: "扫码终端", serialNumber: "SN-002", batchNumber: "B-202608", allocationQty: 1, requiredQty: 3, allocationWarehouse: "华东中心仓" }, createdAt: "2026-08-11" }, { id: "serial-003", values: { serialItem: "扫码终端", serialNumber: "SN-003", batchNumber: "B-202608", allocationQty: 1, requiredQty: 3, allocationWarehouse: "华南仓" }, createdAt: "2026-08-11" }],
  roundRobinHostDemo: [{ id: "host-lin", values: { rrHostName: "林琪", rrHostGroup: "售前咨询组", rrPriority: 3, rrWeight: 60, rrFixed: "false" }, createdAt: "2026-08-11" }, { id: "host-zhou", values: { rrHostName: "周明", rrHostGroup: "售前咨询组", rrPriority: 2, rrWeight: 40, rrFixed: "false" }, createdAt: "2026-08-11" }, { id: "host-wu", values: { rrHostName: "吴宁", rrHostGroup: "专家支持组", rrPriority: 4, rrWeight: 100, rrFixed: "false" }, createdAt: "2026-08-11" }, { id: "host-fixed", values: { rrHostName: "陈顾问", rrHostGroup: "专家支持组", rrPriority: 4, rrWeight: 0, rrFixed: "true" }, createdAt: "2026-08-11" }],
  assetStackDemo: [{ id: "stack-cover", values: { stackAssetName: "门店正面", stackAssetUrl: "/brand/logo.png", stackOrder: 0, stackPrimary: "true", stackRemovable: "false", stackName: "门店巡检组图" }, createdAt: "2026-08-11" }, { id: "stack-detail", values: { stackAssetName: "消防通道", stackAssetUrl: "/brand/miantuan-mark.png", stackOrder: 1, stackPrimary: "false", stackRemovable: "true", stackName: "门店巡检组图" }, createdAt: "2026-08-11" }, { id: "stack-sign", values: { stackAssetName: "巡检标记", stackAssetUrl: "/assets/sliderule-mark.svg", stackOrder: 2, stackPrimary: "false", stackRemovable: "true", stackName: "门店巡检组图" }, createdAt: "2026-08-11" }],
  capacityPolicyDemo: [{ id: "agent-lin", values: { capacityAgent: "林琪", capacityTotal: 12, capacityInbox: 8, capacityLoad: 7, capacityExcluded: "false" }, createdAt: "2026-08-11" }, { id: "agent-zhou", values: { capacityAgent: "周明", capacityTotal: 10, capacityInbox: 6, capacityLoad: 10, capacityExcluded: "false" }, createdAt: "2026-08-11" }, { id: "agent-wu", values: { capacityAgent: "吴宁", capacityTotal: 8, capacityInbox: 5, capacityLoad: 2, capacityExcluded: "true" }, createdAt: "2026-08-11" }],
  notificationPolicyDemo: [{ id: "route-root", values: { routeName: "默认策略", routeParent: "", routeMatcher: "severity=~warning|critical", routeReceiver: "值班群", routeContinue: "false", routeProvisioned: "true" }, createdAt: "2026-08-11" }, { id: "route-critical", values: { routeName: "严重告警", routeParent: "route-root", routeMatcher: "severity=critical", routeReceiver: "电话升级", routeContinue: "true", routeProvisioned: "false" }, createdAt: "2026-08-11" }, { id: "route-payments", values: { routeName: "支付域", routeParent: "route-root", routeMatcher: "service=payments", routeReceiver: "支付团队", routeContinue: "false", routeProvisioned: "false" }, createdAt: "2026-08-11" }],
  criticalPathDemo: [{ id:"task-design",values:{criticalTask:"方案设计",criticalStart:0,criticalDuration:2,criticalDeps:"",criticalFlag:"true"},createdAt:"2026-08-11"},{id:"task-build",values:{criticalTask:"核心开发",criticalStart:2,criticalDuration:4,criticalDeps:"task-design",criticalFlag:"true"},createdAt:"2026-08-11"},{id:"task-test",values:{criticalTask:"联调测试",criticalStart:6,criticalDuration:2,criticalDeps:"task-build",criticalFlag:"true"},createdAt:"2026-08-11"}],
  mitreCoverageDemo: [{id:"t1059",values:{mitreTactic:"执行",mitreTechnique:"T1059 命令解释器",mitreCoverage:82,mitreAlerts:18,mitreMitigation:"限制脚本解释器并审计异常子进程"},createdAt:"2026-08-11"},{id:"t1204",values:{mitreTactic:"执行",mitreTechnique:"T1204 用户执行",mitreCoverage:46,mitreAlerts:7,mitreMitigation:"邮件隔离与用户行为告警"},createdAt:"2026-08-11"},{id:"t1021",values:{mitreTactic:"横向移动",mitreTechnique:"T1021 远程服务",mitreCoverage:68,mitreAlerts:11,mitreMitigation:"限制管理端口并检查异常远程登录"},createdAt:"2026-08-11"}],
  bookingDiagnosticDemo: [{id:"diag-main",values:{diagnosticDate:"2026-08-18",diagnosticCalendar:"工作日历",diagnosticSchedule:"30 分钟产品演示",diagnosticAvailable:"true",diagnosticReason:""},createdAt:"2026-08-11"},{id:"diag-team",values:{diagnosticDate:"2026-08-18",diagnosticCalendar:"团队会议",diagnosticSchedule:"30 分钟产品演示",diagnosticAvailable:"false",diagnosticReason:"14:00–15:00 已有内部会议"},createdAt:"2026-08-11"},{id:"diag-next",values:{diagnosticDate:"2026-08-19",diagnosticCalendar:"工作日历",diagnosticSchedule:"30 分钟产品演示",diagnosticAvailable:"false",diagnosticReason:"超出最短提前预约时间"},createdAt:"2026-08-11"}],
  networkPatchDemo: [{id:"port-a1",values:{patchPort:"A-01",patchDevice:"核心交换机",patchSide:"设备侧",patchOccupied:"false",patchVlan:"VLAN 20",patchOpposite:""},createdAt:"2026-08-11"},{id:"port-a2",values:{patchPort:"A-02",patchDevice:"核心交换机",patchSide:"设备侧",patchOccupied:"true",patchVlan:"VLAN 10",patchOpposite:"B-04"},createdAt:"2026-08-11"},{id:"port-b1",values:{patchPort:"B-01",patchDevice:"机柜配线架",patchSide:"配线架侧",patchOccupied:"false",patchVlan:"VLAN 20",patchOpposite:""},createdAt:"2026-08-11"},{id:"port-b4",values:{patchPort:"B-04",patchDevice:"机柜配线架",patchSide:"配线架侧",patchOccupied:"true",patchVlan:"VLAN 10",patchOpposite:"A-02"},createdAt:"2026-08-11"}],
};
...
const DEMOS: Record<string, { block: ExperienceBlockInstance; extra: Record<string, unknown> }> = {
  ...
  FileShareAccessComposer:{block:{id: "demo-FileShareAccessComposer",type: "FileShareAccessComposer",binding:{entityRef: "fileShareDemo",principalNameFieldRef: "sharePrincipal",shareKindFieldRef: "shareKind",permissionFieldRef: "sharePermission",expiryFieldRef: "shareExpiry",statusFieldRef: "shareStatus",targets:["file"],},},extra:{},},
  IdentitySessionRevocationConsole:{block:{id: "demo-IdentitySessionRevocationConsole",type: "IdentitySessionRevocationConsole",binding:{entityRef: "identitySessionDemo",userFieldRef: "sessionUser",clientFieldRef: "sessionClient",deviceFieldRef: "sessionDevice",ipAddressFieldRef: "sessionIp",lastAccessFieldRef: "sessionLastAccess",targets:["identity-session"],},},extra:{},},
  ColumnLineageImpactExplorer:{block:{id: "demo-ColumnLineageImpactExplorer",type: "ColumnLineageImpactExplorer",binding:{entityRef: "columnLineageDemo",datasetFieldRef: "lineageDataset",columnFieldRef: "lineageColumn",directionFieldRef: "lineageDirection",depthFieldRef: "lineageDepth",impactFieldRef: "lineageImpact",},},extra:{},},
  WorkflowCredentialBindingPanel:{block:{id: "demo-WorkflowCredentialBindingPanel",type: "WorkflowCredentialBindingPanel",binding:{entityRef: "workflowCredentialDemo",slotFieldRef: "credentialSlot",credentialFieldRef: "credentialName",credentialTypeFieldRef: "credentialType",testStatusFieldRef: "credentialStatus",requiredFieldRef: "credentialRequired",targets:["workflow-node"],},},extra:{},},
  MergeApprovalRuleMatrix:{block:{id: "demo-MergeApprovalRuleMatrix",type: "MergeApprovalRuleMatrix",binding:{entityRef: "mergeApprovalDemo",ruleNameFieldRef: "approvalRule",requiredCountFieldRef: "approvalRequired",approvedCountFieldRef: "approvalReceived",approverFieldRef: "approvalApprover",optionalFieldRef: "approvalOptional",invalidFieldRef: "approvalInvalid",targets:["merge-request"],},},extra:{},},
  DocumentMailRuleComposer:{block:{id: "demo-DocumentMailRuleComposer",type: "DocumentMailRuleComposer",binding:{entityRef: "documentMailRuleDemo",accountFieldRef: "mailAccount",folderFieldRef: "mailFolder",conditionFieldRef: "mailCondition",actionFieldRef: "mailAction",actionParameterFieldRef: "mailActionParameter",metadataFieldRef: "mailMetadata",targets:["mail-rule"],},},extra:{},},
  AuthenticationFlowExecutionTree:{block:{id: "demo-AuthenticationFlowExecutionTree",type: "AuthenticationFlowExecutionTree",binding:{entityRef: "authenticationFlowDemo",executionNameFieldRef: "authExecutionName",parentExecutionFieldRef: "authParent",requirementFieldRef: "authRequirement",priorityFieldRef: "authPriority",configurableFieldRef: "authConfigurable",targets:["authentication-flow"],},},extra:{},},
  DashboardFilterScopeMapper:{block:{id: "demo-DashboardFilterScopeMapper",type: "DashboardFilterScopeMapper",binding:{entityRef: "dashboardFilterScopeDemo",nodeKindFieldRef: "scopeKind",nodeLabelFieldRef: "scopeLabel",parentNodeFieldRef: "scopeParent",filterFieldRef: "scopeFilter",targets:["dashboard"],},},extra:{},},
  OrderFulfillmentAllocationComposer:{block:{id: "demo-OrderFulfillmentAllocationComposer",type: "OrderFulfillmentAllocationComposer",binding:{entityRef: "fulfillmentAllocationDemo",orderLineFieldRef: "fulfillLine",productFieldRef: "fulfillProduct",orderedQuantityFieldRef: "fulfillOrdered",warehouseFieldRef: "fulfillWarehouse",availableQuantityFieldRef: "fulfillAvailable",preorderFieldRef: "fulfillPreorder",targets:["order"],},},extra:{},},
  AlertExpressionPipelineBuilder:{block:{id: "demo-AlertExpressionPipelineBuilder",type: "AlertExpressionPipelineBuilder",binding:{entityRef: "alertExpressionDemo",refIdFieldRef: "expressionRef",expressionKindFieldRef: "expressionKind",inputRefFieldRef: "expressionInput",formulaFieldRef: "expressionFormula",previewStatusFieldRef: "expressionPreview",targets:["alert-rule"],},},extra:{},},
  SyncWaveResourceSequencer:{block:{id: "demo-SyncWaveResourceSequencer",type: "SyncWaveResourceSequencer",binding:{entityRef: "syncWaveDemo",resourceNameFieldRef: "syncResource",phaseFieldRef: "syncPhase",waveFieldRef: "syncWave",resourceKindFieldRef: "syncKind",syncStatusFieldRef: "syncStatus",targets:["application"],},},extra:{},},
  ScaffolderTaskExecutionConsole:{block:{id: "demo-ScaffolderTaskExecutionConsole",type: "ScaffolderTaskExecutionConsole",binding:{entityRef: "scaffolderTaskDemo",stepNameFieldRef: "taskStep",stepStatusFieldRef: "taskStepStatus",logFieldRef: "taskLog",outputFieldRef: "taskOutput",durationFieldRef: "taskDuration",targets:["scaffolder-task"],},},extra:{},},
  DatacenterRackUnitPlanner:{block:{id:"demo-DatacenterRackUnitPlanner",type:"DatacenterRackUnitPlanner",props:{units:18},binding:{entityRef:"rackUnitDemo",assetNameFieldRef:"rackAsset",sideFieldRef:"rackSide",unitPositionFieldRef:"rackPosition",unitHeightFieldRef:"rackHeight",horizontalLaneFieldRef:"rackLane",placementStatusFieldRef:"rackStatus",targets:["rack"]}},extra:{}},
  DeviceCommandDispatchConsole:{block:{id:"demo-DeviceCommandDispatchConsole",type:"DeviceCommandDispatchConsole",binding:{entityRef:"deviceCommandDemo",commandTypeFieldRef:"commandType",attributeNameFieldRef:"commandAttribute",attributeTypeFieldRef:"commandAttributeType",requiredFieldRef:"commandRequired",attributeValueFieldRef:"commandValue",availableFieldRef:"commandAvailable",targets:["device"]}},extra:{}},
  SubscriptionPhaseOverrideComposer:{block:{id:"demo-SubscriptionPhaseOverrideComposer",type:"SubscriptionPhaseOverrideComposer",binding:{entityRef:"subscriptionPhaseDemo",planNameFieldRef:"subscriptionPlan",phaseTypeFieldRef:"subscriptionPhase",catalogPriceFieldRef:"catalogPrice",overridePriceFieldRef:"overridePrice",targets:["subscription"]}},extra:{}},
  DocumentPermissionMovePlanner:{block:{id:"demo-DocumentPermissionMovePlanner",type:"DocumentPermissionMovePlanner",binding:{entityRef:"documentMoveDemo",collectionNameFieldRef:"moveCollection",permissionFieldRef:"movePermission",parentCollectionFieldRef:"moveParent",currentCollectionFieldRef:"moveCurrent",writableFieldRef:"moveWritable",descendantFieldRef:"moveDescendant",targets:["document"]}},extra:{}},
  CiStageJobGraphConsole:{block:{id:"demo-CiStageJobGraphConsole",type:"CiStageJobGraphConsole",binding:{entityRef:"ciStageDemo",stageNameFieldRef:"ciStage",jobNameFieldRef:"ciJob",jobStatusFieldRef:"ciStatus",dependencyStatusFieldRef:"ciNeeds",parallelCountFieldRef:"ciParallel",authorizedFieldRef:"ciAuthorized",targets:["pipeline"]}},extra:{}},
  SerialBatchAllocationScanner:{block:{id:"demo-SerialBatchAllocationScanner",type:"SerialBatchAllocationScanner",binding:{entityRef:"serialBatchDemo",itemNameFieldRef:"serialItem",serialNumberFieldRef:"serialNumber",batchNumberFieldRef:"batchNumber",quantityFieldRef:"allocationQty",requiredQuantityFieldRef:"requiredQty",warehouseFieldRef:"allocationWarehouse",targets:["stock-entry"]}},extra:{}},
  RoundRobinHostDistributionComposer:{block:{id:"demo-RoundRobinHostDistributionComposer",type:"RoundRobinHostDistributionComposer",binding:{entityRef:"roundRobinHostDemo",hostNameFieldRef:"rrHostName",hostGroupFieldRef:"rrHostGroup",priorityFieldRef:"rrPriority",weightFieldRef:"rrWeight",fixedHostFieldRef:"rrFixed",targets:["event-type"]}},extra:{}},
  AssetStackPrimaryOrganizer:{block:{id:"demo-AssetStackPrimaryOrganizer",type:"AssetStackPrimaryOrganizer",binding:{entityRef:"assetStackDemo",assetNameFieldRef:"stackAssetName",previewUrlFieldRef:"stackAssetUrl",orderIndexFieldRef:"stackOrder",primaryAssetFieldRef:"stackPrimary",removableFieldRef:"stackRemovable",stackNameFieldRef:"stackName",targets:["asset-stack"]}},extra:{}},
  ConversationCapacityPolicyComposer:{block:{id:"demo-ConversationCapacityPolicyComposer",type:"ConversationCapacityPolicyComposer",binding:{entityRef:"capacityPolicyDemo",agentNameFieldRef:"capacityAgent",capacityFieldRef:"capacityTotal",inboxLimitFieldRef:"capacityInbox",activeLoadFieldRef:"capacityLoad",excludedFieldRef:"capacityExcluded",targets:["assignment-policy"]}},extra:{}},
  NotificationPolicyRouteTree:{block:{id:"demo-NotificationPolicyRouteTree",type:"NotificationPolicyRouteTree",binding:{entityRef:"notificationPolicyDemo",policyNameFieldRef:"routeName",parentPolicyFieldRef:"routeParent",matcherFieldRef:"routeMatcher",receiverFieldRef:"routeReceiver",continueFieldRef:"routeContinue",provisionedFieldRef:"routeProvisioned",targets:["notification-policy"]}},extra:{}},
  CriticalPathDependencyScheduler:{block:{id:"demo-CriticalPathDependencyScheduler",type:"CriticalPathDependencyScheduler",binding:{entityRef:"criticalPathDemo",taskNameFieldRef:"criticalTask",startOffsetFieldRef:"criticalStart",durationFieldRef:"criticalDuration",dependencyIdsFieldRef:"criticalDeps",criticalFieldRef:"criticalFlag",targets:["project-plan"]}},extra:{}},
  MitreTechniqueCoverageNavigator:{block:{id:"demo-MitreTechniqueCoverageNavigator",type:"MitreTechniqueCoverageNavigator",binding:{entityRef:"mitreCoverageDemo",tacticFieldRef:"mitreTactic",techniqueFieldRef:"mitreTechnique",coverageFieldRef:"mitreCoverage",alertCountFieldRef:"mitreAlerts",mitigationFieldRef:"mitreMitigation",targets:["security-coverage"]}},extra:{}},
  BookingAvailabilityTroubleshooter:{block:{id:"demo-BookingAvailabilityTroubleshooter",type:"BookingAvailabilityTroubleshooter",binding:{entityRef:"bookingDiagnosticDemo",diagnosticDateFieldRef:"diagnosticDate",calendarNameFieldRef:"diagnosticCalendar",scheduleNameFieldRef:"diagnosticSchedule",availableFieldRef:"diagnosticAvailable",blockedReasonFieldRef:"diagnosticReason",targets:["event-type"]}},extra:{}},
  NetworkPortPatchPanelComposer:{block:{id:"demo-NetworkPortPatchPanelComposer",type:"NetworkPortPatchPanelComposer",binding:{entityRef:"networkPatchDemo",portNameFieldRef:"patchPort",deviceNameFieldRef:"patchDevice",panelSideFieldRef:"patchSide",occupiedFieldRef:"patchOccupied",vlanFieldRef:"patchVlan",oppositePortFieldRef:"patchOpposite",targets:["network-port"]}},extra:{}},
  RecordForm: {
        block: {
  ...
  return (
    ...
    >
      ...
      */}
      ...
      <div
        data-testid="component-card-metadata"
        className="pointer-events-none absolute inset-x-0 bottom-0 z-10 px-3 pb-2 pt-2 opacity-100 transition-opacity duration-200 [@media(hover:hover)]:opacity-0 group-hover:opacity-100 group-focus-within:opacity-100"
      >
