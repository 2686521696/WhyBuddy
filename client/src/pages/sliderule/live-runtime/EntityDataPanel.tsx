...
export function EntityDataPanel({
  ...
  return (
    <div
      ...
      data-testid="datamodel-data-panel"
    >
      ...
      <div className="flex flex-wrap gap-1.5">
        {entities.map(e => (
          ...
          >
            ...
            <span
              className={
                e.id === entity?.id ? "ml-1 opacity-80" : "ml-1 text-stone-400"
              }
            >
          ...
          <thead className="bg-[#eef0f4]">
            <tr>
              {fields.map(f => (
                <th
                  key={f.id}
                  className="px-2 py-2 text-left font-semibold text-stone-600"
                >
                  {f.name || f.id}
              ...
              <th className="w-14 px-2 py-2 text-left font-semibold text-stone-600">
                操作
              </th>
            </tr>
          </thead>
              ...
              <tr key={row.id}>
                ...
                <td className="px-2 py-0.5">
                  <button
                    ...
                    onClick={() =>
                      entity && apply(deleteRow(state, entity.id, row.id))
                    }
                  >
                    删除
                  </button>
            ...
            {rows.length === 0 && (
              <tr>
                <td
                  ...
                  className="px-3 py-6 text-center text-stone-300"
                >
