 ...
 *
 * 12 是按真机基线定的（4 页 15 块）：当前页的块通常 3~5 个，留出余量让
 * 相邻页的块也能活着，滑过去不会整片闪一下。**这不是标定过的参数**——
 * 真机上量出更好的数就改，别当成 closure_relevance 那种动不得的阈值。
 */
export const DEFAULT_BLOCK_IFRAME_BUDGET = 12;
