...
export const useWorkflowStore = create<WorkflowState>((set, get) => ({
  ...
  fetchWorkflowMonitoringInstance: async (id: string) => {
    ...
    try {
      ...
      console.error(
        "[Store] Failed to fetch workflow monitoring instance:",
        err
      );
      if (get().currentWorkflowId === id) {
        set({
  ...
  fetchWorkflowMonitoringSession: async (id: string) => {
    ...
    try {
      ...
      console.error(
        "[Store] Failed to fetch workflow monitoring session:",
        err
      );
      if (get().currentWorkflowId === id) {
        set({
  ...
  terminateWorkflowMonitoringInstance: async (id: string, reason?: string) => {
    ...
    try {
      ...
      console.error(
        "[Store] Failed to terminate workflow monitoring instance:",
        err
      );
      return null;
    }
