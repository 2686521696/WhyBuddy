...
(
  ...
  PYTHONPATH=slide-rule-python python -m pytest slide-rule-python/tests/test_schema_legal_source.py slide-rule-python/tests/test_v5_llm_generate_gate.py::test_experience_block_catalog_gate_and_repair -q
