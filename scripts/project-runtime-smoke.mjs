...
const mode = ["--lifecycle", "--process"].includes(args[0]) ? args.shift() : null;
const script = mode === "--lifecycle" ? "project-lifecycle-smoke.py"
  : mode === "--process" ? "project-process-smoke.py" : "project-runtime-smoke.py";
