...
def test_batch7_catalog_keeps_its_401_baseline_without_alias_counting():
    assert legal.EXPERIENCE_BLOCK_CATALOG_VERSION >= 401
    assert len(legal.EXPERIENCE_BLOCKS) >= 401
