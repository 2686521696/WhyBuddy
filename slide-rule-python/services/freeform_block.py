...
#   1024x1792  ⚠️ 不报错，但**返回 1254x1254 的正方形**——这个端点上根本
#              拿不到竖版画布（活体探针 2026-07-30）。所以手机专属档的参照板
#              也走横版，改成并排画两屏手机，见 _build_overview_sheet_prompt。
#              注意 _DEVICE_IMAGE_SIZE["phone"] 也填的这个值，那条路径同样
#              拿不到竖图（是既有问题，不在本次改动范围内）。
