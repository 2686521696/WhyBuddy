...
PROJECT_WRITE_TOOLS = frozenset({"project_create", "project_patch", "project_start", "project_exec"})
...
_DESCRIPTIONS = {
    ...
    "project_patch": "Apply exact file replacements/deletions to the current session project. Require expectedRevision and per-file expectedSha256 (null only for new files). Runtime must be stopped and reconciled first. Persists a new revision; old verification is not proof for it.",
