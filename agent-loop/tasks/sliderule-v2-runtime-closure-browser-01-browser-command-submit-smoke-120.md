# sliderule-v2-runtime-closure-browser-01-browser-command-submit-smoke-120
...
- AgentLoop run id: `2026-07-03T16-36-45-006Z`
...
## Objective
Add a browser smoke path that submits a normal command on /agent-loop/sliderule and observes a completed turn.
