...
- `agent-loop/tasks/sliderule-v2-closure-ui-06-sliderule-closure-visual-smoke-119.md`
...
This adds deterministic SSR smoke coverage for the visible publish-closure state used by `/agent-loop/sliderule`. The smoke fixture covers closed state, blocked state with blocker details, blocked state with missing top blocker details, and absent publish closure so the UI does not fabricate stale closure evidence.
