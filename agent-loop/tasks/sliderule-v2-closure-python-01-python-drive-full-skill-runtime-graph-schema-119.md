...
Reviewed and landed as part of the Python `/drive-full` closure batch. Evidence lives in `slide-rule-python/services/v5_skill_runtime_graph.py`, `slide-rule-python/routes/sliderule_full.py`, and `slide-rule-python/tests/test_v5_skill_runtime_graph.py`.
...
Public API names remain stable: `derive_skill_runtime_graph_response`, `/api/sliderule/drive-full`, and top-level `skillRuntimeGraph`.
