...
- `agent-loop/tasks/sliderule-v2-closure-ui-02-sliderule-skill-linkage-click-target-119.md`
...
This lands stable click and focus targets for skill linkage rows and closure blocker rows without adding modal state or changing the panel layout. Linkage source/target skills now expose button targets with stable test ids and skill data attributes; closure blocker affected skill/ref values expose matching button targets while preserving the row-level audit attributes.
