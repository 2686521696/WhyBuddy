...
- `agent-loop/tasks/sliderule-v2-closure-report-02-sliderule-report-write-runtime-closure-119.md`
...
This lands report.write runtime closure inclusion in the delivery/export path. When a trusted report.write artifact exists, `serializeSlideRuleDeliveryMd()` now renders the enriched report closure appendix directly under the human report section; when no report exists it keeps the existing fail-closed standalone closure section.
