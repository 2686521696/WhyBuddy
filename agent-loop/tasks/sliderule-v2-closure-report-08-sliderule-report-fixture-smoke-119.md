...
- `agent-loop/tasks/sliderule-v2-closure-report-08-sliderule-report-fixture-smoke-119.md`
...
This lands fixture smoke coverage for closed, blocked, and absent closure report output. The serializer tests exercise closed publishClosure, blocked publishClosure with top blockers, and absent-evidence fail-closed output through `buildClearStateWithTrustedReport()` fixtures.
