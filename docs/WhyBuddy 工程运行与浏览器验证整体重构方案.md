...
P6 ????????????????Studio ??????? `SandboxPreviewSurface`????????????????????????????????? revision/hash CAS????????? supervisor??????????? revision????????????????????????

???????????????????? reader ???????/??/???????????reader ?????????? npm ci/build??? Chrome 13 ????????? HTTPS ??????????? `x-forwarded-proto` ???? Cookie????????????????????????????????? dist???????????????? E2B ???????????

rollout ????????????????????????????????????????????????????????????????????????? `pnpm run project:preflight` ????????????????????????/???/??????? `disabled`?????????????Dockerfile ? compose overlay ??????????????????? Docker daemon????????????

?????`artifacts/project-product/1789248858-89f6c4d5/browser-report.json`???????????????????`artifacts/project-browser-p4/local-tasks-python-decoder.json`??? Chrome ??????`artifacts/project-workspace-browser-1789248031964/report.json`?????? Chrome??`artifacts/project-model/1789248575-f3c20242/report.json`??????????????? content_filter?????????????????????????????

?????P1 ? P6 ???????UI ??????????????????P6 ??????????????????/?????????????????????????????? `not_configured`?`blocked` ? `failed` ?????????? HTML ???
