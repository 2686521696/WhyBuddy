...
| `codegen` | 79 | 2715 | 产品：agent / tools / shell / pager / workspace |
| `common` | 12 | 166 | 跨产品叶子：tool-runtime / protocol / tracing / compaction |
...
|---|---:|---:|---:|---|---|
| `xai-grok-config` | 19 | 4 | 27 | codegen | Shared config loading for Grok — grok_home, effective config (requirements > user > managed), TOML merge |
| `xai-tty-utils` | 19 | 0 | 10 | codegen | Lightweight process-spawning utilities for TTY safety — detach from controlling terminal, suppress interactive pagers, process-group lifecycle |
| `xai-grok-version` | 17 | 0 | 2 | codegen | Lockstepped grok CLI version. |
| `xai-dirs` | 16 | 0 | 1 | codegen | Home-directory resolution generally: USERPROFILE-first home_dir, plus grok-home ($GROK_HOME or <home>/.grok) |
| `xai-grok-tools` | 15 | 18 | 262 | codegen | Grok tools library |
...
| `xai-grok-telemetry` | 9 | 13 | 59 | codegen | Telemetry engine: product events + Mixpanel emission + Sentry error reporting for Grok Build sessions |
...
| `xai-computer-hub-sdk` | 6 | 5 | 23 | common | SDK for the xAI Computer Hub: connection pool, transparent reconnect, tool harness, and tool-server runtime. |

## 依赖别人最多的 crate（组合根 / 大块）

| crate | 出度 | 入度 | .rs | 层 |
|---|---:|---:|---:|---|
| `xai-grok-shell` | 55 | 4 | 633 | codegen |
| `xai-grok-workspace` | 34 | 6 | 107 | codegen |
| `xai-grok-pager` | 33 | 2 | 780 | codegen |
| `xai-grok-tools` | 18 | 15 | 262 | codegen |
| `xai-grok-pager-bin` | 14 | 0 | 3 | codegen |
| `xai-grok-telemetry` | 13 | 9 | 59 | codegen |
| `xai-grok-pager-render` | 12 | 1 | 79 | codegen |
| `xai-grok-mcp` | 11 | 3 | 15 | codegen |
| `xai-grok-agent` | 8 | 5 | 31 | codegen |
| `xai-grok-memory` | 7 | 1 | 17 | codegen |
| `xai-grok-shared` | 7 | 3 | 8 | codegen |
| `xai-grok-shell-terminal` | 7 | 1 | 11 | codegen |
| `xai-file-utils` | 6 | 6 | 12 | codegen |
...
| crate | .rs | 入度 | 出度 |
|---|---:|---:|---:|
| `xai-grok-pager` | 780 | 2 | 33 |
| `xai-grok-shell` | 633 | 4 | 55 |
| `xai-grok-tools` | 262 | 15 | 18 |
| `xai-grok-workspace` | 107 | 6 | 34 |
| `xai-grok-pager-render` | 79 | 1 | 12 |
| `xai-fast-worktree` | 76 | 3 | 4 |
| `xai-grok-telemetry` | 59 | 9 | 13 |
...
flowchart TB
  ...
  c_xai_message_delivery_core["xai-message-delivery-core<br/>4 rs · in 1"]
...
flowchart TB
  ...
  c_xai_codebase_graph["xai-codebase-graph<br/>27 rs · in 2"]
  c_xai_dirs["xai-dirs<br/>1 rs · in 16"]
  ...
  c_xai_grok_config["xai-grok-config<br/>27 rs · in 19"]
  c_xai_grok_config_types["xai-grok-config-types<br/>7 rs · in 4"]
  ...
  c_xai_grok_mcp["xai-grok-mcp<br/>15 rs · in 3"]
  c_xai_grok_pager["xai-grok-pager<br/>780 rs · in 2"]
  c_xai_grok_paths["xai-grok-paths<br/>1 rs · in 5"]
  c_xai_grok_sampler["xai-grok-sampler<br/>38 rs · in 3"]
  ...
  c_xai_grok_telemetry["xai-grok-telemetry<br/>59 rs · in 9"]
  c_xai_grok_tools["xai-grok-tools<br/>262 rs · in 15"]
  c_xai_grok_tools_api["xai-grok-tools-api<br/>5 rs · in 3"]
  c_xai_grok_version["xai-grok-version<br/>2 rs · in 17"]
  c_xai_grok_workspace["xai-grok-workspace<br/>107 rs · in 6"]
  ...
  c_xai_tty_utils["xai-tty-utils<br/>10 rs · in 19"]
...
| `xai-dirs` | codegen | 1 | 16 | 0 | `crates/codegen/xai-dirs` | Home-directory resolution generally: USERPROFILE-first home_dir, plus grok-home ($GROK_HOME or <home>/.grok) |
...
| `xai-file-utils` | codegen | 12 | 6 | 6 | `crates/codegen/xai-file-utils` | Local data collection: upload queueing and blob storage |
...
| `xai-grok-config` | codegen | 27 | 19 | 4 | `crates/codegen/xai-grok-config` | Shared config loading for Grok — grok_home, effective config (requirements > user > managed), TOML merge |
| `xai-grok-config-types` | codegen | 7 | 4 | 3 | `crates/codegen/xai-grok-config-types` | Leaf configuration value types for the grok CLI, extracted from xai-grok-shell for dependency inversion. |
...
| `xai-grok-mcp` | codegen | 15 | 3 | 11 | `crates/codegen/xai-grok-mcp` | MCP integration crate. Quarantines rmcp + reqwest 0.13 (rmcp 3.x requires reqwest >= 0.13.2 while the rest of the workspace uses reqwest 0.12) and owns the MCP credential store and OAuth flow orchestrator. |
...
| `xai-grok-pager` | codegen | 780 | 2 | 33 | `crates/codegen/xai-grok-pager` |  |
...
| `xai-grok-pager-pty-harness` | codegen | 49 | 0 | 3 | `crates/codegen/xai-grok-pager-pty-harness` | Shared PTY harness + scenario library for xai-grok-pager e2e tests and benchmarks. |
...
| `xai-grok-sampler` | codegen | 38 | 3 | 4 | `crates/codegen/xai-grok-sampler` | Actor-based sampling/inference layer for xAI grok (HTTP streaming + retry, no shell coupling) |
...
| `xai-grok-shared` | codegen | 8 | 3 | 7 | `crates/codegen/xai-grok-shared` |  |
| `xai-grok-shell` | codegen | 633 | 4 | 55 | `crates/codegen/xai-grok-shell` |  |
...
| `xai-grok-telemetry` | codegen | 59 | 9 | 13 | `crates/codegen/xai-grok-telemetry` | Telemetry engine: product events + Mixpanel emission + Sentry error reporting for Grok Build sessions |
...
| `xai-grok-tools` | codegen | 262 | 15 | 18 | `crates/codegen/xai-grok-tools` | Grok tools library |
| `xai-grok-tools-api` | codegen | 5 | 3 | 2 | `crates/codegen/xai-grok-tools-api` | Protobuf API definitions for Grok tools |
| `xai-grok-update` | codegen | 16 | 2 | 6 | `crates/codegen/xai-grok-update` |  |
...
| `xai-grok-workspace` | codegen | 107 | 6 | 34 | `crates/codegen/xai-grok-workspace` | Core host-local workspace library (FS, VCS, execution, discovery) for xai-grok-shell and remote sampler |
...
| `xai-message-delivery-core` | common | 4 | 1 | 0 | `crates/common/xai-message-delivery-core` |  |
...
| `xai-tty-utils` | codegen | 10 | 19 | 0 | `crates/codegen/xai-tty-utils` | Lightweight process-spawning utilities for TTY safety — detach from controlling terminal, suppress interactive pagers, process-group lifecycle |
